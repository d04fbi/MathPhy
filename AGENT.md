...
$$s = \lim \limits_{m \to \infty} 2^m \sqrt{2r^2 - 2r \hat{a}_{m,m}}$$

$$2^m \sqrt{2r^2 - 2r \hat{a}_{m,0}} = s$$

$$\frac{2^m \sqrt{2r^2 - 2r \hat{a}_{m,0}}}{2^m} = \frac{s}{2^m}$$

$$\sqrt{2r^2 - 2r \hat{a}_{m,0}} = \frac{s}{2^m}$$

$$\left(\sqrt{2r^2 - 2r \hat{a}_{m,0}}\right)^2 = \left(\frac{s}{2^m}\right)^2$$

$$2r^2 - 2r \hat{a}_{m,0} = \left(\frac{s}{2^m}\right)^2$$

$$2r^2 - 2r \hat{a}_{m,0} = \frac{s^2}{\left(2^m\right)^2}$$

$$2r^2 - 2r \hat{a}_{m,0} = \frac{s^2}{2^{2m}}$$

$$2r^2 - 2r \hat{a}_{m,0} - 2r^2 = \frac{s^2}{2^{2m}} - 2r^2$$

$$-2r \hat{a}_{m,0} = \frac{s^2}{2^{2m}} - 2r^2$$

$$\frac{-2r \hat{a}_{m,0}}{-2r} = \frac{\left(\frac{s^2}{2^{2m}}\right) - 2r^2}{-2r}$$

$$\hat{a}_{m,0} = \frac{\left(\frac{s^2}{2^{2m}}\right) - 2r^2}{-2r}$$

$$\hat{a}_{m,0} = \frac{\left(\frac{s^2}{2^{2m}}\right)}{-2r} - \frac{2r^2}{-2r}$$

$$\hat{a}_{m,0} = \frac{s^2}{2^{2m}(-2r)} - \frac{2r^2}{-2r}$$

$$\hat{a}_{m,0} = \frac{s^2}{-2^{2m+1}r} - \frac{2r^2}{-2r}$$

$$\hat{a}_{m,0} = \frac{s^2}{-2^{2m+1}r} + \frac{-2r^2}{-2r}$$

$$\hat{a}_{m,0} = \frac{s^2}{-2^{2m+1}r} + r$$

$$\hat{a}_{m,0} = r + \frac{s^2}{-2^{2m+1}r}$$

$$\hat{a}_{m,0} = r - \left(-\frac{s^2}{-2^{2m+1}r}\right)$$

$$\hat{a}_{m,0} = r - \left(\frac{-s^2}{-2^{2m+1}r}\right)$$

$$\hat{a}_{m,0} = r - \frac{s^2}{2^{2m+1}r}$$

$$r a_{m,0} = r - \frac{s^2}{2^{2m+1}r}$$

$$\frac{r a_{m,0}}{r} = \frac{r - \left(\frac{s^2}{2^{2m+1}r}\right)}{r}$$

$$\frac{r a_{m,0}}{r} = \frac{r}{r} - \frac{\left(\frac{s^2}{2^{2m+1}r}\right)}{r}$$
...
$$\hat{a}_{m,n} = \frac{\sqrt{2r^2 + 2r \hat{a}_{m,n-1}}}{2} \quad \text{for } n \leq m$$

$$\hat{a}_{m,n-1} = \frac{\sqrt{2r^2 + 2r \hat{a}_{m,n}}}{2} \quad \text{for } n \leq m$$

$$2 \hat{a}_{m,n-1} = 2 \frac{\sqrt{2r^2 + 2r \hat{a}_{m,n}}}{2} \quad \text{for } n \leq m$$

$$2 \hat{a}_{m,n-1} = \frac{2 \sqrt{2r^2 + 2r \hat{a}_{m,n}}}{2} \quad \text{for } n \leq m$$

$$2 \hat{a}_{m,n-1} = \sqrt{2r^2 + 2r \hat{a}_{m,n}} \quad \text{for } n \leq m$$

$$(2 \hat{a}_{m,n-1})^2 = \left(\sqrt{2r^2 + 2r \hat{a}_{m,n}}\right)^2 \quad \text{for } n \leq m$$

$$2^2 \hat{a}_{m,n-1}^2 = \left(\sqrt{2r^2 + 2r \hat{a}_{m,n}}\right)^2 \quad \text{for } n \leq m$$

$$4 \hat{a}_{m,n-1}^2 = \left(\sqrt{2r^2 + 2r \hat{a}_{m,n}}\right)^2 \quad \text{for } n \leq m$$

$$4 \hat{a}_{m,n-1}^2 = 2r^2 + 2r \hat{a}_{m,n} \quad \text{for } n \leq m$$

$$4 \hat{a}_{m,n-1}^2 - 2r^2 = 2r^2 + 2r \hat{a}_{m,n} - 2r^2 \quad \text{for } n \leq m$$

$$4 \hat{a}_{m,n-1}^2 - 2r^2 = 2r \hat{a}_{m,n} \quad \text{for } n \leq m$$

$$\frac{4 \hat{a}_{m,n-1}^2 - 2r^2}{2r} = \frac{2r \hat{a}_{m,n}}{2r} \quad \text{for } n \leq m$$

$$\frac{4 \hat{a}_{m,n-1}^2}{2r} - \frac{2r^2}{2r} = \frac{2r \hat{a}_{m,n}}{2r} \quad \text{for } n \leq m$$

$$\frac{2 \hat{a}_{m,n-1}^2}{r} - \frac{2r^2}{2r} = \frac{2r \hat{a}_{m,n}}{2r} \quad \text{for } n \leq m$$

$$\frac{2 \hat{a}_{m,n-1}^2}{r} - r = \frac{2r \hat{a}_{m,n}}{2r} \quad \text{for } n \leq m$$

$$\frac{2 \hat{a}_{m,n-1}^2}{r} - r = \hat{a}_{m,n} \quad \text{for } n \leq m$$

$$\hat{a}_{m,n} = \frac{2 \hat{a}_{m,n-1}^2}{r} - r \quad \text{for } n \leq m$$
...
$$\cos(r,s) = r \lim \limits_{m \to \infty} T_{2^m}\left(a_{m,0}\right)$$
