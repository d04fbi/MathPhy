...
$$s = \lim \limits_{n \to \infty} 2^n \sqrt{2r^2 - 2r a_n}$$
...
$$\arccos(r,x) = \lim \limits_{n \to \infty} 2^n \sqrt{2r^2 - 2r a_n}$$
$$a_n = \frac{\sqrt{2r^2 + 2ra_{n-1}}}{2}$$
$$a_0 = x \quad \text{ for } -r \leq x \leq r$$
...
Adopt Theorem 1.1 with $\cos(r,s)$ as the initial condition

$$s = \lim \limits_{n \to \infty} 2^n \sqrt{2r^2 - 2r a_n}$$
$$a_n = \frac{\sqrt{2r^2 + 2ra_{n-1}}}{2}$$
$$a_0 = \cos(r,s)$$

Rewrite Theorem 1.1 in double-index notation

$$s = \lim \limits_{m \to \infty} 2^m \sqrt{2r^2 - 2r a_{m,m}}$$
$$a_{m,n} = \frac{\sqrt{2r^2 + 2ra_{m,n-1}}}{2} \quad \text{for } n \leq m$$
$$a_{m,0} = \cos(r,s)$$

Invert Theorem 1.1 by interchanging the variables and reversing the direction of the recurrence relation

$$\cos(r,s) = \lim \limits_{m \to \infty} a_{m,m}$$
$$a_{m,n-1} = \frac{\sqrt{2r^2 + 2ra_{m,n}}}{2} \quad \text{for } n \leq m$$
$$2^m \sqrt{2r^2 - 2r a_{m,0}} = s$$

Solve for the initial condition $a_{m,0}$
...
Normalize the initial condition $a_{m,0}$
...
Solve for the recursive step $a_{m,n}$
...
Normalize the recursive step $a_{m,n}$
...
Equate the normalized recursive step $\hat{a}_{m,n}$ with the Chebyshev polynomial of the first kind of order $2^m$

$$\hat{a}_{m,n} = T_{2^m}\left(\hat{a}_{m,0}\right)$$
...
$$T_{2\left(2^{n-1}\right)}(x) = 2 (T_{2^{n-1}}(x))^2 - 1$$
