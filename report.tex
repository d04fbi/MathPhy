...
\end{abstract}
\section*{The circular sector and the circular functions}
\begin{subequations}
\begin{gather}
...
\end{equation}
\begin{equation}
\hat{a}_{m,n} = \sum \limits_{k=0}^{2^n} \left(\frac{2^{k}}{(2k)!} \prod \limits_{j=0}^{k-1} ((2^n)^2 - j^2)\right) \left(-\frac{s^2}{2^{2m+1}r^2}\right)^k \quad \text{for } n \leq m
\end{equation}
\begin{equation}
