...
\end{equation}
\subsection{The circular functions}
...
\end{equation}
\begin{equation}
\sin(r, \cdot) : s \mapsto r \sum \limits_{k=0}^{\infty} \frac{(-1)^k \left(\frac{s}{r}\right)^{2k+1}}{(2k+1)!}
\end{equation}
\end{landscape}
...
\end{equation}
\begin{equation}
\frac{\partial \sin(r,s)}{\partial s} = \frac{\partial \left(r \sum \limits_{k=0}^{\infty} \frac{(-1)^k \left(\frac{s^{2k+1}}{r^{2k+1}}\right)}{(2k+1)!}\right)}{\partial s}
\end{equation}
\begin{equation}
...
\end{equation}
\begin{equation}
\frac{\partial \sin(r,s)}{\partial s} = \sum \limits_{k=0}^{\infty} \frac{(-1)^k \left(\frac{\partial s^{2k+1}}{\partial s}\right)}{r^{2k} (2k+1)!}
\end{equation}
\begin{equation}
\frac{\partial \sin(r,s)}{\partial s} = \sum \limits_{k=0}^{\infty} \frac{(-1)^k (2k+1) s^{2k}}{r^{2k} (2k+1)!}
\end{equation}
\begin{equation}
\frac{\partial \sin(r,s)}{\partial s} = \sum \limits_{k=0}^{\infty} \frac{(-1)^k (2k+1) \left(\frac{s^{2k}}{r^{2k}}\right)}{(2k+1)!}
\end{equation}
\begin{equation}
...
\end{equation}
\begin{equation}
\frac{\partial \cos(r,s)}{\partial s} = \frac{\partial \left(r \sum \limits_{k=0}^{\infty} \frac{(-1)^k \left(\frac{s^{2k}}{r^{2k}}\right)}{(2k)!}\right)}{\partial s}
\end{equation}
\begin{equation}
...
\end{equation}
\begin{equation}
\frac{\partial \cos(r,s)}{\partial s} = \sum \limits_{k=0}^{\infty} \frac{(-1)^k \left(\frac{\partial s^{2k}}{\partial s}\right)}{r^{2k-1} (2k)!}
\end{equation}
\begin{equation}
\frac{\partial \cos(r,s)}{\partial s} = \sum \limits_{k=1}^{\infty} \frac{(-1)^k (2k) s^{2k-1}}{r^{2k-1} (2k)!}
\end{equation}
\begin{equation}
\frac{\partial \cos(r,s)}{\partial s} = \sum \limits_{k=1}^{\infty} \frac{(-1)^k (2k) \left(\frac{s^{2k-1}}{r^{2k-1}}\right)}{(2k)!}
\end{equation}
\begin{equation}
