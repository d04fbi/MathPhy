...
\begin{gather}
\cos(r,\alpha - \beta) = a_{0,0} \\
a_{0,0} = r - \frac{\left(\sqrt{\left(\cos(r,\alpha) - \cos(r,\beta)\right)^2 + \left(\sin(r,\alpha) - \sin(r,\beta)\right)^2}\right)^2}{2^{2 \cdot 0 + 1}r}
\end{gather}
\end{subequations}
\begin{equation}
\cos(r,\alpha - \beta) = r - \frac{\left(\sqrt{\left(\cos(r,\alpha) - \cos(r,\beta)\right)^2 + \left(\sin(r,\alpha) - \sin(r,\beta)\right)^2}\right)^2}{2^{2 \cdot 0 + 1}r}
\end{equation}
\begin{equation}
\cos(r,\alpha - \beta) = r - \frac{\left(\cos(r,\alpha) - \cos(r,\beta)\right)^2 + \left(\sin(r,\alpha) - \sin(r,\beta)\right)^2}{2^{2 \cdot 0 + 1}r}
\end{equation}
\begin{equation}
...
\end{equation}
\begin{equation}
\hat{a}_{m,n} = \sum \limits_{k=0}^{2^n} \frac{2^{k} \left(-\frac{s^2}{2^{2m+1}r^2}\right)^k}{(2k)!} \prod \limits_{j=0}^{k-1} ((2^n)^2 - j^2) \quad \text{for } n \leq m
\end{equation}
\begin{equation}
\hat{a}_{m,n} = \sum \limits_{k=0}^{2^n} \frac{\left(2 \left(-\frac{s^2}{2^{2m+1}r^2}\right)\right)^k}{(2k)!} \prod \limits_{j=0}^{k-1} ((2^n)^2 - j^2) \quad \text{for } n \leq m
\end{equation}
\begin{equation}
\hat{a}_{m,n} = \sum \limits_{k=0}^{2^n} \frac{\left(-2 \frac{s^2}{2^{2m+1}r^2}\right)^k}{(2k)!} \prod \limits_{j=0}^{k-1} ((2^n)^2 - j^2) \quad \text{for } n \leq m
\end{equation}
\begin{equation}
\hat{a}_{m,n} = \sum \limits_{k=0}^{2^n} \frac{\left(-\frac{2s^2}{2^{2m+1}r^2}\right)^k}{(2k)!} \prod \limits_{j=0}^{k-1} ((2^n)^2 - j^2) \quad \text{for } n \leq m
\end{equation}
\begin{equation}
\hat{a}_{m,n} = \sum \limits_{k=0}^{2^n} \frac{\left(-\frac{s^2}{2^{2m}r^2}\right)^k}{(2k)!} \prod \limits_{j=0}^{k-1} ((2^n)^2 - j^2) \quad \text{for } n \leq m
\end{equation}
\begin{equation}
\hat{a}_{m,n} = \sum \limits_{k=0}^{2^n} \frac{\left(-\frac{s^2}{(2^2)^{m}r^2}\right)^k}{(2k)!} \prod \limits_{j=0}^{k-1} ((2^n)^2 - j^2) \quad \text{for } n \leq m
\end{equation}
\begin{equation}
\hat{a}_{m,n} = \sum \limits_{k=0}^{2^n} \frac{\left(-\frac{s^2}{4^{m}r^2}\right)^k}{(2k)!} \prod \limits_{j=0}^{k-1} ((2^n)^2 - j^2) \quad \text{for } n \leq m
\end{equation}
\begin{equation}
\hat{a}_{m,n} = \sum \limits_{k=0}^{2^n} \frac{(-1)^k \left(\frac{s^2}{4^{m}r^2}\right)^k}{(2k)!} \prod \limits_{j=0}^{k-1} ((2^n)^2 - j^2) \quad \text{for } n \leq m
\end{equation}
\begin{equation}
\hat{a}_{m,n} = \sum \limits_{k=0}^{2^n} \frac{(-1)^k \left(\frac{\left(\frac{s^2}{r^2}\right)}{4^m}\right)^k}{(2k)!} \prod \limits_{j=0}^{k-1} ((2^n)^2 - j^2) \quad \text{for } n \leq m
\end{equation}
\begin{equation}
\hat{a}_{m,n} = \sum \limits_{k=0}^{2^n} \frac{(-1)^k \left(\frac{\left(\frac{s}{r}\right)^2}{4^m}\right)^k}{(2k)!} \prod \limits_{j=0}^{k-1} ((2^n)^2 - j^2) \quad \text{for } n \leq m
\end{equation}
\begin{equation}
\hat{a}_{m,n} = \sum \limits_{k=0}^{2^n} \frac{(-1)^k \frac{\left(\left(\frac{s}{r}\right)^2\right)^k}{(4^m)^k}}{(2k)!} \prod \limits_{j=0}^{k-1} ((2^n)^2 - j^2) \quad \text{for } n \leq m
\end{equation}
\begin{equation}
\hat{a}_{m,n} = \sum \limits_{k=0}^{2^n} \frac{(-1)^k \frac{\left(\frac{s}{r}\right)^{2k}}{(4^m)^k}}{(2k)!} \prod \limits_{j=0}^{k-1} ((2^n)^2 - j^2) \quad \text{for } n \leq m
\end{equation}
\begin{equation}
