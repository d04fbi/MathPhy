...
\end{equation*}
\begin{equation*}
\cos(r,\alpha - \beta) = \frac{2r^2 - \cos^2(r,\alpha) - \cos^2(r,\beta) - \sin^2(r,\alpha) - \sin^2(r,\beta) + 2 \cos(r,\alpha) \cos(r,\beta) + 2 \sin(r,\alpha) \sin(r,\beta)}{2r}
\end{equation*}
\begin{equation*}
\cos(r,\alpha - \beta) = \frac{2r^2 - \left(\cos^2(r,\alpha) + \cos^2(r,\beta)\right) - \sin^2(r,\alpha) - \sin^2(r,\beta) + 2 \cos(r,\alpha) \cos(r,\beta) + 2 \sin(r,\alpha) \sin(r,\beta)}{2r}
\end{equation*}
\begin{equation*}
\cos(r,\alpha - \beta) = \frac{2r^2 - r^2 - \sin^2(r,\alpha) - \sin^2(r,\beta) + 2 \cos(r,\alpha) \cos(r,\beta) + 2 \sin(r,\alpha) \sin(r,\beta)}{2r}
\end{equation*}
\begin{equation*}
\cos(r,\alpha - \beta) = \frac{r^2 - \sin^2(r,\alpha) - \sin^2(r,\beta) + 2 \cos(r,\alpha) \cos(r,\beta) + 2 \sin(r,\alpha) \sin(r,\beta)}{2r}
\end{equation*}
\begin{equation*}
\cos(r,\alpha - \beta) = \frac{r^2 - \left(\sin^2(r,\alpha) + \sin^2(r,\beta)\right) + 2 \cos(r,\alpha) \cos(r,\beta) + 2 \sin(r,\alpha) \sin(r,\beta)}{2r}
\end{equation*}
\begin{equation*}
